...
const EmployeeForm = ({ employee, onSuccess, onCancel }) => {
  ...
  const validationSchema = Yup.object({
    ...
    fingerprintId: Yup.string().nullable(),
    ...
    salary: Yup.number().min(0, "يجب أن يكون الرقم موجب").required("حقل مطلوب"),
  ...
  const formik = useFormik({
    initialValues: {
      ...
      fingerprintId: employee?.fingerprintId || "", // Add this line
    ...
    onSubmit: async (values) => {
      ...
      try {
        const url = employee
          ? `${apiUrl}/api/employees/${employee._id}`
        ...
        const dataToSend = {
          ...
          isHR: Boolean(formik.values.isHR),
          gender: values.gender,
          fingerprintId: values.fingerprintId.trim(),
  ...
  const addPenalty = () => {
    if (formik.values.newPenaltyDate && formik.values.newPenaltyDescription) {
      ...
      formik.setFieldValue("penalties", [
        ...formik.values.penalties,
        newPenalty,
      ]);
  ...
  const inputClass = (touched, error) =>
    `w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 ${
      touched && error
  ...
  const sectionClass =
    "space-y-4 p-5 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300";
  ...
  return (
    <form
      ...
      className="space-y-6 p-6 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-xl"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className={sectionClass}>
          ...
          <div className="grid grid-cols-2 gap-4">
              ...
              <div className="relative">
                <input
                  ...
                  className={inputClass(
                    formik.touched.fingerprintId,
                    formik.errors.fingerprintId
                  )}
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    id="isHR"
                    name="isHR"
                    checked={formik.values.isHR}
                    onChange={formik.handleChange}
                    className="mr-2"
                  />
                  <label htmlFor="isHR" className="text-gray-700">
                    موظف موارد بشرية
                  </label>
                </div>
              </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                <FaUser className="ml-1 text-sm text-blue-500" /> الحالة
                الاجتماعية
              </label>
              <select
                name="maritalStatus"
        ...
        <div className={sectionClass}>
          <h3 className={sectionHeaderClass}>
            <FaMoneyBillWave className="ml-2 text-blue-500" /> المعلومات المالية
            والتعليمية
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <button
                  ...
                  onClick={() =>
                    formik.setFieldValue(
                      "familyMembers",
                      Math.max(0, formik.values.familyMembers - 1)
                    )
                  }
          ...
          <div className={sectionClass}>
            <h3 className={sectionHeaderClass}>
              <FaMoneyBillWave className="ml-2 text-blue-500" /> آخر زيادة في
              الراتب
            </h3>
            ...
            <div>
              ...
              <DatePicker
                ...
                onChange={(date) =>
                  formik.setFieldValue("lastSalaryIncreaseDate", date)
                }
                dateFormat="yyyy/MM/dd"
                className={inputClass(
                  formik.touched.lastSalaryIncreaseDate,
                  formik.errors.lastSalaryIncreaseDate
                )}
            ...
            <div>
              ...
              <input
                ...
                onBlur={formik.handleBlur}
                className={inputClass(
                  formik.touched.lastSalaryIncreaseAmount,
                  formik.errors.lastSalaryIncreaseAmount
                )}
                min="0"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
              <div>
                ...
                <DatePicker
                  ...
                  onChange={(date) =>
                    formik.setFieldValue("newPenaltyDate", date)
                  }
                  dateFormat="yyyy/MM/dd"
        ...
        >
          {isSubmitting ? (
            ...
            <>
              ...
              {employee ? "تحديث البيانات" : "حفظ البيانات"}
            </>
          )}
        </button>
      </div>
